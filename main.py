...
try: string=raw_input("Please input the message or ciphertext you'd like to start with: ") 
except NameError: string=input("Please input the message or ciphertext you'd like to start with: ")
